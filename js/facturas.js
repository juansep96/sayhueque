...
function CargarSucursales(){
    ...
    .then((data)=>{
      ...
      data.forEach((e)=>{
        ...
        $("#sucursal_fac").append(opcion);
      })
      $.post("./api/ObtenerIDSucursal")
      .then((idSucursal)=>{
        $("#sucursal_fac").val(idSucursal);
      })
      CargarFacturas();
    });
  }
...
function CargarFacturas(){
    ...
    $('#facturas').DataTable({
      ...
      'ajax': {
        'url': urlBase+"ObtenerFacturas?fecha="+fecha+"&fechaHasta="+fechaHasta+"&idSucursal="+sucursal,
      },
      'columns': [{
          data: 'fecha_factura'
        },
